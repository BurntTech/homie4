...
class Device_Base(object):
    ...
    def publish_homeassistant(self):
        ...
        HASS_PAYLOADS = {
            ...
            'dimmer': f'{{"name": "{self.name}","command_topic": "homie/{self.device_id}/dimmer/dimmer/set","brightness_command_topic": "homie/{self.device_id}/dimmer/dimmer/set","brightness_state_topic": "homie/{self.device_id}/dimmer/dimmer","state_topic": "homie/{self.device_id}/dimmer/dimmer",state_value_template: "{{ \'0\' if value == \'0\' else \'99\' }}","on_command_type": "brightness","brightness_scale": "100","payload_on" : "100","payload_off" : "0"}}',
